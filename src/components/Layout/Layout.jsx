        ...
        <div id="container">
            ...
            <nav id="top-nav">
                ...
                <div id="top-nav-links-container-div">
                    ...
                    <Link to="/mycalender" id="nav-item-top-calendar" className="nav-item-top-cart-calender-icons"><CalendarMonthSharpIcon /></Link>
                    <Link to="/cart" id="nav-item-top-cart" className="nav-item-top-cart-calender-icons"><AddShoppingCartSharpIcon /></Link>
                    <div id="user-welcome">{`${topNavName}`}</div>
                    {topNavName !== "User" && <button id="sign-out-btn" onClick={() => {
                        setTopNavName('User')
                ...
                <div className="show">
                    <label for="checkbox" className="toggle" onClick={() => setmobile(!mobile)} >
            ...
            <nav id="bot-nav">
                ...
                <div id="fast-links">
                    ...
                    <Link to="/help" className="nav-item-bot">Help</Link>
                ...
                <div className="card">
                        <a href="https://www.instagram.com/" target="_blank" className="socialContainer containerOne">
                        ...
                        <a href="https://twitter.com/" target="_blank" className="socialContainer containerTwo">
                        ...
                        <a href="https://www.linkedin.com/" target="_blank" className="socialContainer containerThree">
                        ...
                        <a href="https://www.whatsapp.com/" target="_blank" className="socialContainer containerFour">
