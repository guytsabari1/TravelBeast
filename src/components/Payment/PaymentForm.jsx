...
function PaymentForm({ show, setShow }) {
      ...
      {show && (
        <form className="form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="btn-div">
            <button className="purchase--btn" type="submit" onClick={onSubmit}>Checkout</button>
